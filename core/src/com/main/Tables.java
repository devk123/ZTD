...
public class Tables {
    ...
    static void init(){
        ...
        zombie_resources.put("angel", Resources.angel);
        ...
        tooltips.put("mounted", "Spawn a wall full of mounted cannons.");
        ...
        values.put("speed_angel", 2);

        //ZOMBIE HEALTH
        values.put("health_dif", 100);
        values.put("health_speedy", 2);
        values.put("health_fast", 3);
        values.put("health_riot", 10);
        values.put("health_angel", 4);

        //ZOMBIE SCORE
        values.put("score_zombie", 1);
        values.put("score_speedy", 2);
        values.put("score_riot", 5);
        values.put("score_dif", 500);
        values.put("score_fast", 3);
        values.put("score_angel", 4);

        //ANIMATION COLUMNS
        values.put("columns_laser", 16);
        values.put("columns_speedy", 6);
        values.put("columns_angel", 2);
